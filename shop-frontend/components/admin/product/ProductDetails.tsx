    ...
    return (
        <div className="page">
            ...
            <h2 className="page-title">
                {action === "create" ? "Creating a new product" : `Editing product with ID: ${product.id}`}
            </h2>
            
            <form onSubmit={action === "update" ? updateProduct : postProduct}>
                ...
                <div className="form-group">
                    <div className="button-group">
                        ...
                        {action === "update" && (
                            <button type="button" onClick={handleDeleteClick} disabled={loading} className="action-btn">
                                Delete Product
                            </button>
                        )}
                    </div>
